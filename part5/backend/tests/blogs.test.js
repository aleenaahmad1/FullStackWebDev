...
describe('favourite blog', () => {
  ...
  test('of a bigger list is calculated right', () => {
    ...
    assert.deepStrictEqual(fav_blog, result)
  })

  test('when list has only one blog, equals the blog', () => {
    const result = listHelper.favouriteBlog(single)
    assert.deepStrictEqual(result, single[0])
  })
})
...
describe('Most common author', () => {
  ...
  test('when list has only one blog, equals the blog', () => {
    ...
    assert.deepStrictEqual('Michael Chan', result)
  })
})
...
describe('Most liked author', () => {
  ...
  test('of a bigger list is calculated right', () => {
    ...
    assert.deepStrictEqual(correct, result)
  })
